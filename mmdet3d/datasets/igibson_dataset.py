...
class IGibsonDataset(Custom3DDataset):
    ...
    This class serves as the API for experiments on the IGibson Dataset.
    ...
    def get_data_info(self, index):
        ...
        if self.modality["use_lidar"]:
            ...
            # print(f'pts_filename: {pts_filename}')
    ...
    def show(self, results, out_dir, show=True, pipeline=None):
        ...
        for i, result in enumerate(results):
            ...
            show_result_v2(points, gt_corners, gt_labels, pred_corners, pred_labels, out_dir, file_name)
