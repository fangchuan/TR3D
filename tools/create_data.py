...
def igibson_data_prep(root_path, info_prefix, out_dir, workers):
    """Prepare the info file for IGibson dataset.
...
def waymo_data_prep(root_path, info_prefix, version, out_dir, workers, max_sweeps=5):
    ...
    for i, split in enumerate(splits):
        ...
        converter = waymo.Waymo2KITTI(
            load_dir, save_dir, prefix=str(i), workers=workers, test_mode=(split == "testing")
        )
        converter.convert()
